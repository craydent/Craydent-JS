    ...
    function _subQuery(record, query, operator, field) {
        ...
        switch(operator) {
            case "$equals":
                ...
                return isRegex ? query[field].test(value) : 
            ...
            case "$exists":
                ...
                return finished.validPath == query["$exists"];
            ...
            case "$where":
                return $c.isFunction(query) ? query.call(record) : tryEval.call(record, "(function(){"+query+"}).call(this)");
            ...
            case "$and":
                return __andNotHelper (record, query, operands);
            ...
            case "$not": 
                ...
                var isRegex =  query == RegExp;
                return isRegex ? query.test(value) : value == query;
...
//                    } else if(this[i].hasOwnProperty[prop] && !(satisfied = this[i][prop] == condition[prop])) {
    ...
    _ao("propertyValue", function(path, delimiter, finished) {
        try {
            delimiter = delimiter || ".";
