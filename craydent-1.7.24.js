...
/---------------------------------------------------------------------------------------------------------------*/
var __version = "1.7.24",
__thisIsNewer = true,
$w = window,
$d = document,
$l = $w.location;

if (window.__craydentLoaded) {
...
if (__thisIsNewer) {
    ...
    */
    ...
    //ARRAY SORTING
    _ext(Array, 'sortBy', function(props, rev, primer, lookup){
        if(props.isString()){props=[props];}
    ...
    _ext(Array, 'sortByLookup', function(prop,lookup,rev,primer){
        //prop="TABLE_SORT";
