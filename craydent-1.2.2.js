...
for (var i = 0, len = _craydentSelects.length; i < len; i++) {
	...
	window[_craydentSelect.func] = eval('window.'+_craydentSelect.func+' = (function (object, single) {try {return _craydentSelector(\''+_craydentSelect.selector+'\', \''+_craydentSelect.overwrite+'\', object, single);} catch (e) {error('+_craydentSelect.func+', e);}})');
