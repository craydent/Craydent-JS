...
//      }
        ...
        eval("$w."+name+"= Craydent."+name+" = "+fnew);
...
_df('trim', String.prototype.trim, true);
...
_df('ltrim', String.prototype.ltrim, true);
...
_df('rtrim', String.prototype.rtrim, true);
...
_df('sanitize', String.prototype.sanitize, true);
...
_df('isValidEmail', String.prototype.isValidEmail, true);
...
_df('isBlank', String.prototype.isBlank, true);
...
_df('capitalize', String.prototype.capitalize, true);
...
_df('toDomElement', String.prototype.toDomElement, true);
...
_df('convertUTCDate', String.prototype.convertUTCDate, true);
...
_df('toCurrencyNotation', String.prototype.toCurrencyNotation, true);

String.prototype.replace_all = String.prototype.replace_all || function(replace, subject) {
    try {
...
_df('replace_all', String.prototype.replace_all, true);

String.prototype.ireplace_all = String.prototype.replace_all || function(replace, subject) {
    try {
...
_df('ireplace_all', String.prototype.ireplace_all, true);
...
_df('reverse', String.prototype.reverse, true);
...
_df('filter', Array.prototype.filter, true);
...
_df('isEmpty', Array.prototype.isEmpty, true);
...
_df('indexOf', Array.prototype.indexOf, true);
...
_df('indexOfAlt', Array.prototype.indexOfAlt, true);
...
_df('replaceAt', Array.prototype.replaceAt, true);
...
_df('insertAfter', Array.prototype.insertAfter, true);
...
_df('insertBefore', Array.prototype.insertBefore, true);
...
_df('trim', Array.prototype.trim, true);

Array.prototype.condense = Array.prototype.condense || function (check_values) {
    try {
        for (var i = 0, len = this.length; i < len; i++) {
            if (check_values) {
                var index = 0;
...
_df('condense', Array.prototype.condense, true);
...
_df('remove', Array.prototype.remove, true);
...
_df('removeAll', Array.prototype.removeAll, true);
...
_df('removeAt', Array.prototype.removeAt, true);
...
_df('map', Array.prototype.map, true);
...
_df('every', Array.prototype.every, true);



//ARRAY SORTING
Array.prototype.sortBy = Array.prototype.sortBy || function(props, rev, primer, lookup){
...
_df('sortBy', Array.prototype.sortBy, true);

Array.prototype.sortByLookup = Array.prototype.sortByLookup || function(prop,lookup,rev,primer){
    //prop="TABLE_SORT";
...
_df('sortByLookup', Array.prototype.sortByLookup, true);
...
_df('format', Date.prototype.format, true);
...
_df('aboutEqualTo', Number.prototype.aboutEqualTo, true);
...
_df('isOdd', Number.prototype.isOdd, true);
...
_df('isEven', Number.prototype.isEven, true);
...
_df('toCurrencyNotation', Number.prototype.toCurrencyNotation, true);
...
function ajax(params){
    try {
        var need_to_shard = false, browser_url_limit = 1500;
        ...
        if (params.dataType.toLowerCase() == 'jsonp') {
            ...
            if (params.shard_data && params.query && !$w.isObject(params.query) && params.query.length > browser_url_limit) {
                ...
                query_parts.map(function(str){
                    ...
                    this[name_value[0]] = name_value[1];
                },params.query);
            } else if (params.query && $w.isObject(params.query)) {
                var query = $w.toStringAlt(params.query, '=', '&');
            ...
            if (need_to_shard) {
                ...
                for (prop in params.query) {
                    var pair = '&' + prop + "=" + params.query[prop];
    ...
    try {
        ...
        for (var i = 0, len = objs.length; i < len; i++) {
            ...
            template = htmlTemplate.ireplace_all("${this}",
                ($w.isObject(obj) && parseRaw(obj,true).replace_all(';', ';\\').replace_all('[','\\[').replace(']','\\]') || obj)).ireplace_all("${index}", i);
